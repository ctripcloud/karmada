...
const (
	...
	deleteResourceToCluster                    = "delete_resource_to_cluster"
...
// CountDeleteResourceToCluster records the number of updating operation of the resource to a target member cluster.
func CountDeleteResourceToCluster(err error, apiVersion, kind, cluster string) {
