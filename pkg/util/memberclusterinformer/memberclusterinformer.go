...
// MemberClusterInformer builds informers and registers event handlers for resources in member cluster.
...
// NewMemberClusterInformer builds a MemberClusterInformer.
...
func (m *memberClusterInformerImpl) getGVRsFromWork(work *workv1alpha1.Work) (map[schema.GroupVersionResource]bool, error) {
